...
from .indicators_common import indicator_value, indicator_window_report
...
def get_stock_stats_indicators_window(
    ...
    """Indicator window computed from Yahoo bars.

    The maths is vendor-independent (stockstats over a price frame), so it lives
    in ``indicators_common``; this pins the price source to Yahoo.
    """
    return indicator_window_report(
        symbol, indicator, curr_date, look_back_days, vendor="yfinance"
    )
...
def get_stockstats_indicator(
    ...
    """Single-day indicator value from Yahoo bars."""
    return indicator_value(symbol, indicator, curr_date, vendor="yfinance")
