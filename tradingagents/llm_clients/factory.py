...
def create_llm_client(
    ...
    **kwargs,
    ...
    # Not an HTTP endpoint at all: shells out to the local `claude` binary and
    # rides the user's Claude Code session, so no API key is involved.
    if provider_lower in ("claude_code", "claude-code"):
