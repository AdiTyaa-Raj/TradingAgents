...
MODEL_OPTIONS: ProviderModeOptions = {
    ...
    # Claude Code resolves family aliases to whatever the signed-in plan
    # currently serves, so the aliases are listed first and stay correct across
    # model releases. Full IDs still work through "Custom model ID".
    "claude_code": {
        "quick": [
            ("Sonnet - latest Sonnet, best speed/intelligence balance", "sonnet"),
            ("Haiku - latest Haiku, fastest and cheapest against your plan", "haiku"),
            ("Custom model ID", "custom"),
        ],
        "deep": [
            ("Opus - latest Opus, frontier reasoning", "opus"),
            ("Fable - most capable, long-running agents", "fable"),
            ("Sonnet - near-frontier at lower plan usage", "sonnet"),
            ("Custom model ID", "custom"),
        ],
    },
    "google": {
